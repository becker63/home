...
class KCLInput(Resource):
    class Builder(BaseModelBuilder):
        ...
        def api_version(self, value: Optional[Literal["krm.kcl.dev/v1alpha1"]], /) -> Self:
            """
    ...
    api_version: Annotated[Optional[Literal["krm.kcl.dev/v1alpha1"]], Field(alias="apiVersion")] = (
