...
class ProviderConfigUsage(Resource):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["ProviderConfigUsage"]:
            return ProviderConfigUsage

        def build(self) -> "ProviderConfigUsage":
            return ProviderConfigUsage(**self._attrs)
        ...
        def kind(self, value: Optional[Literal["ProviderConfigUsage"]], /) -> Self:
            """
        ...
        def provider_config_ref(
            self, value_or_callback: ProviderConfigRef, /
        ) -> "ProviderConfigUsage.Builder": ...
        ...
        @overload
        def resource_ref(
            self, value_or_callback: ResourceRef, /
        ) -> "ProviderConfigUsage.Builder": ...
    ...
    class BuilderContext(BuilderContextBase["ProviderConfigUsage.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = ProviderConfigUsage.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for ProviderConfigUsage."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["ProviderConfigUsage", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use ProviderConfigUsage.list_builder() instead."
            )
    ...
    provider_config_ref: Annotated[ProviderConfigRef, Field(alias="providerConfigRef")]
    """
    ProviderConfigReference to the provider config being used.
    """
    resource_ref: Annotated[ResourceRef, Field(alias="resourceRef")]
    """
    ResourceReference to the managed resource using the provider config.
    """
