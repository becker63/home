...
class ProjectRef(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["ProjectRef"]:
            return ProjectRef

        def build(self) -> "ProjectRef":
            return ProjectRef(**self._attrs)
        ...
        @overload
        def policy(self, value_or_callback: Optional[Policy], /) -> "ProjectRef.Builder": ...
    ...
    class BuilderContext(BuilderContextBase["ProjectRef.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = ProjectRef.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for ProjectRef."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["ProjectRef", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use ProjectRef.list_builder() instead."
            )
...
class ProjectSelector(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["ProjectSelector"]:
            return ProjectSelector

        def build(self) -> "ProjectSelector":
            return ProjectSelector(**self._attrs)
        ...
        @overload
        def policy(self, value_or_callback: Optional[Policy], /) -> "ProjectSelector.Builder": ...
    ...
    class BuilderContext(BuilderContextBase["ProjectSelector.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = ProjectSelector.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for ProjectSelector."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["ProjectSelector", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use ProjectSelector.list_builder() instead."
            )
...
class ForProviderModel(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def project_ref(
            self, value_or_callback: Optional[ProjectRef], /
        ) -> "ForProviderModel.Builder": ...

        @overload
        def project_ref(
            self,
            value_or_callback: Callable[[ProjectRef.Builder], ProjectRef.Builder | ProjectRef],
            /,
        ) -> "ForProviderModel.Builder": ...

        @overload
        def project_ref(self, value_or_callback: Never = ...) -> "ProjectRef.BuilderContext": ...

        def project_ref(self, value_or_callback=None, /):
            """
            Reference to a Project in project to populate project.
            """
            if self._in_context and value_or_callback is None:
                context = ProjectRef.BuilderContext()
                context._parent_builder = self
                context._field_name = "project_ref"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(ProjectRef.builder())
                if isinstance(output, ProjectRef.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("project_ref", value)

        @overload
        def project_selector(
            self, value_or_callback: Optional[ProjectSelector], /
        ) -> "ForProviderModel.Builder": ...
        ...
        def project_selector(
            self,
            value_or_callback: Callable[
                [ProjectSelector.Builder], ProjectSelector.Builder | ProjectSelector
            ],
            /,
        ) -> "ForProviderModel.Builder": ...
        ...
        def project_selector(
            self, value_or_callback: Never = ...
        ) -> "ProjectSelector.BuilderContext": ...

        def project_selector(self, value_or_callback=None, /):
            """
            Selector for a Project in project to populate project.
            """
            if self._in_context and value_or_callback is None:
                context = ProjectSelector.BuilderContext()
                context._parent_builder = self
                context._field_name = "project_selector"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(ProjectSelector.builder())
                if isinstance(output, ProjectSelector.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("project_selector", value)
    ...
    project ID
    """
    project_ref: Annotated[Optional[ProjectRef], Field(alias="projectRef")] = None
    """
    Reference to a Project in project to populate project.
    """
    project_selector: Annotated[Optional[ProjectSelector], Field(alias="projectSelector")] = None
    """
    Selector for a Project in project to populate project.
    """
    resources: Optional[List[str]] = None
...
class ResourcesSpec(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["ResourcesSpec"]:
            return ResourcesSpec

        def build(self) -> "ResourcesSpec":
            return ResourcesSpec(**self._attrs)
    ...
    class BuilderContext(BuilderContextBase["ResourcesSpec.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = ResourcesSpec.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for ResourcesSpec."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["ResourcesSpec", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use ResourcesSpec.list_builder() instead."
            )
...
class ResourcesStatus(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["ResourcesStatus"]:
            return ResourcesStatus

        def build(self) -> "ResourcesStatus":
            return ResourcesStatus(**self._attrs)

        @overload
        def at_provider(
            self, value_or_callback: Optional[AtProviderModel], /
        ) -> "ResourcesStatus.Builder": ...
    ...
    class BuilderContext(BuilderContextBase["ResourcesStatus.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = ResourcesStatus.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for ResourcesStatus."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["ResourcesStatus", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use ResourcesStatus.list_builder() instead."
            )
...
class Resources(Resource):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def spec(self, value_or_callback: ResourcesSpec, /) -> "Resources.Builder": ...

        @overload
        def spec(
            self,
            value_or_callback: Callable[
                [ResourcesSpec.Builder], ResourcesSpec.Builder | ResourcesSpec
            ],
            /,
        ) -> "Resources.Builder": ...

        @overload
        def spec(self, value_or_callback: Never = ...) -> "ResourcesSpec.BuilderContext": ...

        def spec(self, value_or_callback=None, /):
            if self._in_context and value_or_callback is None:
                context = ResourcesSpec.BuilderContext()
                context._parent_builder = self
                context._field_name = "spec"
                return context
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(ResourcesSpec.builder())
                if isinstance(output, ResourcesSpec.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("spec", value)
        ...
        @overload
        def status(
            self, value_or_callback: Optional[ResourcesStatus], /
        ) -> "Resources.Builder": ...
        ...
        def status(
            self,
            value_or_callback: Callable[
                [ResourcesStatus.Builder], ResourcesStatus.Builder | ResourcesStatus
            ],
            /,
        ) -> "Resources.Builder": ...

        @overload
        def status(self, value_or_callback: Never = ...) -> "ResourcesStatus.BuilderContext": ...

        def status(self, value_or_callback=None, /):
            if self._in_context and value_or_callback is None:
                context = ResourcesStatus.BuilderContext()
                context._parent_builder = self
                context._field_name = "status"
                return context
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(ResourcesStatus.builder())
                if isinstance(output, ResourcesStatus.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("status", value)
    ...
    metadata: Optional[apimachinery.ObjectMeta] = None
    spec: ResourcesSpec
    status: Optional[ResourcesStatus] = None
