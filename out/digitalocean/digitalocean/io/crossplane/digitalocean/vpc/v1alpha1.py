...
class ForProvider(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def ip_range(self, value: Optional[str], /) -> Self:
            """
            ...
            """
            return self._set("ip_range", value)
    ...
    A free-form description for the VPC
    """
    ip_range: Annotated[Optional[str], Field(alias="ipRange")] = None
    """
    The range of IP addresses for the VPC in CIDR notation. Network ranges cannot overlap with other networks in the same account and must be in range of private addresses as defined in RFC1918. It may not be larger than /16 or smaller than /24.
    The range of IP addresses for the VPC in CIDR notation
    """
...
class VPCSpec(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["VPCSpec"]:
            return VPCSpec

        def build(self) -> "VPCSpec":
            return VPCSpec(**self._attrs)
        ...
        @overload
        def for_provider(self, value_or_callback: ForProvider, /) -> "VPCSpec.Builder": ...
    ...
    class BuilderContext(BuilderContextBase["VPCSpec.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = VPCSpec.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for VPCSpec."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["VPCSpec", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use VPCSpec.list_builder() instead."
            )
...
class VPCStatus(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["VPCStatus"]:
            return VPCStatus

        def build(self) -> "VPCStatus":
            return VPCStatus(**self._attrs)
        ...
        @overload
        def conditions(self, value_or_callback: List[Condition], /) -> "VPCStatus.Builder": ...
    ...
    class BuilderContext(BuilderContextBase["VPCStatus.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = VPCStatus.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for VPCStatus."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["VPCStatus", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use VPCStatus.list_builder() instead."
            )
...
class VPC(Resource):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["VPC"]:
            return VPC

        def build(self) -> "VPC":
            return VPC(**self._attrs)

        def api_version(
            self, value: Optional[Literal["vpc.digitalocean.crossplane.io/v1alpha1"]], /
        ) -> Self:
            """
        ...
        def kind(self, value: Optional[Literal["VPC"]], /) -> Self:
            """
        ...
        @overload
        def spec(self, value_or_callback: VPCSpec, /) -> "VPC.Builder": ...

        @overload
        def spec(
            self,
            value_or_callback: Callable[[VPCSpec.Builder], VPCSpec.Builder | VPCSpec],
            /,
        ) -> "VPC.Builder": ...

        @overload
        def spec(self, value_or_callback: Never = ...) -> "VPCSpec.BuilderContext": ...

        def spec(self, value_or_callback=None, /):
            if self._in_context and value_or_callback is None:
                context = VPCSpec.BuilderContext()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(VPCSpec.builder())
                if isinstance(output, VPCSpec.Builder):
                    value = output.build()
                else:
                    value = output
        ...
        @overload
        def status(self, value_or_callback: Optional[VPCStatus], /) -> "VPC.Builder": ...

        @overload
        def status(
            self,
            value_or_callback: Callable[[VPCStatus.Builder], VPCStatus.Builder | VPCStatus],
            /,
        ) -> "VPC.Builder": ...

        @overload
        def status(self, value_or_callback: Never = ...) -> "VPCStatus.BuilderContext": ...

        def status(self, value_or_callback=None, /):
            if self._in_context and value_or_callback is None:
                context = VPCStatus.BuilderContext()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(VPCStatus.builder())
                if isinstance(output, VPCStatus.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("status", value)

    class BuilderContext(BuilderContextBase["VPC.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = VPC.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for VPC."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["VPC", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use VPC.list_builder() instead."
            )
    ...
    api_version: Annotated[
        Optional[Literal["vpc.digitalocean.crossplane.io/v1alpha1"]],
        Field(alias="apiVersion"),
    ] = "vpc.digitalocean.crossplane.io/v1alpha1"
    """
    APIVersion defines the versioned schema of this representation of an object.
    Servers should convert recognized schemas to the latest internal value, and
    may reject unrecognized values.
