...
class CompositionRevisionSpec(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def pipeline(
            self, value_or_callback: List[Pipeline], /
        ) -> "CompositionRevisionSpec.Builder": ...
    ...
    class ListBuilder(GenericListBuilder["CompositionRevisionSpec", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use CompositionRevisionSpec.list_builder() instead."
            )
...
class CompositionRevisionStatus(BaseModel):
    ...
    class ListBuilder(GenericListBuilder["CompositionRevisionStatus", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use CompositionRevisionStatus.list_builder() instead."
            )
...
class CompositionSpec(BaseModel):
    ...
    resources that Crossplane should create or update.
    """
    pipeline: Annotated[Optional[List[Pipeline]], Field(max_length=99, min_length=1)] = None
    """
    Pipeline is a list of composition function steps that will be used when a
    composite resource referring to this composition is created. One of
    resources and pipeline must be specified - you cannot specify both.
...
class CompositionRevision(Resource):
    class Builder(BaseModelBuilder):
        ...
        def kind(self, value: Optional[Literal["CompositionRevision"]], /) -> Self:
            """
            Kind is a string value representing the REST resource this object represents.
            Servers may infer this from the endpoint the client submits requests to.
            Cannot be updated.
        ...
        @overload
        def spec(
            self, value_or_callback: Optional[CompositionRevisionSpec], /
        ) -> "CompositionRevision.Builder": ...
        ...
        @overload
        def status(
            self, value_or_callback: Optional[CompositionRevisionStatus], /
        ) -> "CompositionRevision.Builder": ...
    ...
    class ListBuilder(GenericListBuilder["CompositionRevision", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use CompositionRevision.list_builder() instead."
            )
    ...
    """
    metadata: Optional[apimachinery.ObjectMeta] = None
    spec: Optional[CompositionRevisionSpec] = None
    status: Optional[CompositionRevisionStatus] = None
