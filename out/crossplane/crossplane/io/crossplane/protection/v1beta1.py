...
class ClusterUsageSpec(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def by(self, value_or_callback: Optional[By], /) -> "ClusterUsageSpec.Builder": ...
        ...
        @overload
        def of(self, value_or_callback: Of, /) -> "ClusterUsageSpec.Builder": ...
    ...
    class ListBuilder(GenericListBuilder["ClusterUsageSpec", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use ClusterUsageSpec.list_builder() instead."
            )
...
class ClusterUsageStatus(BaseModel):
    ...
    class ListBuilder(GenericListBuilder["ClusterUsageStatus", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use ClusterUsageStatus.list_builder() instead."
            )
...
class ResourceRefModel(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["ResourceRefModel"]:
            return ResourceRefModel

        def build(self) -> "ResourceRefModel":
            return ResourceRefModel(**self._attrs)
    ...
    class BuilderContext(BuilderContextBase["ResourceRefModel.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = ResourceRefModel.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for ResourceRefModel."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["ResourceRefModel", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use ResourceRefModel.list_builder() instead."
            )
...
class ResourceSelectorModel(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["ResourceSelectorModel"]:
            return ResourceSelectorModel

        def build(self) -> "ResourceSelectorModel":
            return ResourceSelectorModel(**self._attrs)
    ...
    class BuilderContext(BuilderContextBase["ResourceSelectorModel.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = ResourceSelectorModel.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for ResourceSelectorModel."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["ResourceSelectorModel", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use ResourceSelectorModel.list_builder() instead."
            )
...
class ClusterUsage(Resource):
    class Builder(BaseModelBuilder):
        ...
        def api_version(
            self, value: Optional[Literal["protection.crossplane.io/v1beta1"]], /
        ) -> Self:
            """
        ...
        def kind(self, value: Optional[Literal["ClusterUsage"]], /) -> Self:
            """
        ...
        @overload
        def status(
            self, value_or_callback: Optional[ClusterUsageStatus], /
        ) -> "ClusterUsage.Builder": ...
    ...
    class ListBuilder(GenericListBuilder["ClusterUsage", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use ClusterUsage.list_builder() instead."
            )
    ...
    api_version: Annotated[
        Optional[Literal["protection.crossplane.io/v1beta1"]], Field(alias="apiVersion")
    ...
    status: Optional[ClusterUsageStatus] = None
