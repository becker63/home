...
class GitRepositoryStatus(BaseModel):
    ...
    Conditions holds the conditions for the GitRepository.
    """
    content_config_checksum: Annotated[Optional[str], Field(alias="contentConfigChecksum")] = None
    """
    ContentConfigChecksum is a checksum of all the configurations related to
    the content of the source artifact:
     - .spec.ignore
...
class Bucket(Resource):
    class Builder(BaseModelBuilder):
        ...
        def api_version(
            self, value: Optional[Literal["source.toolkit.fluxcd.io/v1beta2"]], /
        ) -> Self:
            """
    ...
    api_version: Annotated[
        Optional[Literal["source.toolkit.fluxcd.io/v1beta2"]], Field(alias="apiVersion")
