...
class Observability(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def trace_verbosity(self, value: Optional[Literal["minimal", "detailed"]], /) -> Self:
            """
            TraceVerbosity defines the verbosity level of the tracing for this router.
            """
            return self._set("trace_verbosity", value)
    ...
    Metrics enables metrics for this router.
    """
    trace_verbosity: Annotated[
        Optional[Literal["minimal", "detailed"]], Field(alias="traceVerbosity")
    ] = "minimal"
    """
    TraceVerbosity defines the verbosity level of the tracing for this router.
    """
...
class HealthCheck(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def unhealthy_interval(self, value: Optional[Union[int, str]], /) -> Self:
            """
            UnhealthyInterval defines the frequency of the health check calls for unhealthy targets.
            When UnhealthyInterval is not defined, it defaults to the Interval value.
            Default: 30s
            """
            return self._set("unhealthy_interval", value)
    ...
    Default: 5s
    """
    unhealthy_interval: Annotated[Optional[Union[int, str]], Field(alias="unhealthyInterval")] = (
        None
    )
    """
    UnhealthyInterval defines the frequency of the health check calls for unhealthy targets.
...
class PassiveHealthCheck(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["PassiveHealthCheck"]:
            return PassiveHealthCheck

        def build(self) -> "PassiveHealthCheck":
            return PassiveHealthCheck(**self._attrs)

        def failure_window(self, value: Optional[Union[int, str]], /) -> Self:
            """
            ...
            """
            return self._set("failure_window", value)

        def max_failed_attempts(self, value: Optional[int], /) -> Self:
            """
            ...
            """
            return self._set("max_failed_attempts", value)

    class BuilderContext(BuilderContextBase["PassiveHealthCheck.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = PassiveHealthCheck.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for PassiveHealthCheck."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["PassiveHealthCheck", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use PassiveHealthCheck.list_builder() instead."
            )
    ...
    failure_window: Annotated[Optional[Union[int, str]], Field(alias="failureWindow")] = None
    """
    FailureWindow defines the time window during which the failed attempts must occur for the server to be marked as unhealthy. It also defines for how long the server will be considered unhealthy.
    """
    max_failed_attempts: Annotated[Optional[int], Field(alias="maxFailedAttempts")] = None
    """
    MaxFailedAttempts is the number of consecutive failed attempts allowed within the failure window before marking the server as unhealthy.
    """
...
class Service(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def passive_health_check(
            self, value_or_callback: Optional[PassiveHealthCheck], /
        ) -> "Service.Builder": ...
        ...
        def passive_health_check(
            ...
            value_or_callback: Callable[
                [PassiveHealthCheck.Builder],
                PassiveHealthCheck.Builder | PassiveHealthCheck,
            ],
            /,
        ) -> "Service.Builder": ...
        ...
        ) -> "PassiveHealthCheck.BuilderContext": ...

        def passive_health_check(self, value_or_callback=None, /):
            """
            PassiveHealthCheck defines passive health checks for ExternalName services.
            """
            if self._in_context and value_or_callback is None:
                context = PassiveHealthCheck.BuilderContext()
                context._parent_builder = self
                context._field_name = "passive_health_check"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(PassiveHealthCheck.builder())
                if isinstance(output, PassiveHealthCheck.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("passive_health_check", value)
        ...
        def strategy(
            self,
            value: Optional[Literal["wrr", "p2c", "hrw", "leasttime", "RoundRobin"]],
            /,
        ) -> Self:
            """
    ...
    By default, passHostHeader is true.
    """
    passive_health_check: Annotated[
        Optional[PassiveHealthCheck], Field(alias="passiveHealthCheck")
    ] = None
    """
    PassiveHealthCheck defines passive health checks for ExternalName services.
    """
    ...
    More info: https://doc.traefik.io/traefik/v3.6/reference/routing-configuration/http/load-balancing/service/#sticky-sessions
    """
    strategy: Optional[Literal["wrr", "p2c", "hrw", "leasttime", "RoundRobin"]] = None
    """
    Strategy defines the load balancing strategy between the servers.
    Supported values are: wrr (Weighed round-robin), p2c (Power of two choices), hrw (Highest Random Weight), and leasttime (Least-Time).
    RoundRobin value is deprecated and supported for backward compatibility.
...
class ServersTransportSpec(BaseModel):
    ...
    InsecureSkipVerify disables SSL certificate verification.
    """
    max_idle_conns_per_host: Annotated[Optional[int], Field(alias="maxIdleConnsPerHost", ge=-1)] = (
        None
    )
    """
    MaxIdleConnsPerHost controls the maximum idle (keep-alive) to keep per-host.
...
class HighestRandomWeight(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["HighestRandomWeight"]:
            return HighestRandomWeight

        def build(self) -> "HighestRandomWeight":
            return HighestRandomWeight(**self._attrs)

        @overload
        def services(
            self, value_or_callback: List[ServiceModel2], /
        ) -> "HighestRandomWeight.Builder": ...
    ...
    class BuilderContext(BuilderContextBase["HighestRandomWeight.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = HighestRandomWeight.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for HighestRandomWeight."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["HighestRandomWeight", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use HighestRandomWeight.list_builder() instead."
            )
...
class TraefikServiceSpec(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def highest_random_weight(
            self, value_or_callback: Optional[HighestRandomWeight], /
        ...
        def highest_random_weight(
            ...
            value_or_callback: Callable[
                [HighestRandomWeight.Builder],
                HighestRandomWeight.Builder | HighestRandomWeight,
            ],
            /,
        ) -> "TraefikServiceSpec.Builder": ...
        ...
        def highest_random_weight(
            self, value_or_callback: Never = ...
        ) -> "HighestRandomWeight.BuilderContext": ...

        def highest_random_weight(self, value_or_callback=None, /):
            """
            HighestRandomWeight defines the highest random weight service configuration.
            """
            if self._in_context and value_or_callback is None:
                context = HighestRandomWeight.BuilderContext()
                context._parent_builder = self
                context._field_name = "highest_random_weight"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(HighestRandomWeight.builder())
                if isinstance(output, HighestRandomWeight.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("highest_random_weight", value)
    ...
    highest_random_weight: Annotated[
        Optional[HighestRandomWeight], Field(alias="highestRandomWeight")
    ] = None
    """
    HighestRandomWeight defines the highest random weight service configuration.
    """
