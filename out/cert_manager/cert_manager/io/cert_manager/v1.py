...
class Condition(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def last_transition_time(self, value: Optional[AwareDatetime], /) -> Self:
            """
    ...
    last_transition_time: Annotated[Optional[AwareDatetime], Field(alias="lastTransitionTime")] = (
        None
    )
    """
    LastTransitionTime is the timestamp corresponding to the last status
...
class CertificateRequestStatus(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def ca(self, value: Optional[Base64Str], /) -> Self:
            """
        ...
        def certificate(self, value: Optional[Base64Str], /) -> Self:
            """
        ...
        def failure_time(self, value: Optional[AwareDatetime], /) -> Self:
            """
    ...
    If not set, the CA is assumed to be unknown/not available.
    """
    certificate: Optional[Base64Str] = None
    """
    The PEM encoded X.509 certificate resulting from the certificate
    signing request.
    If not set, the CertificateRequest has either not been completed or has
    ...
    Known condition types are `Ready`, `InvalidRequest`, `Approved` and `Denied`.
    """
    failure_time: Annotated[Optional[AwareDatetime], Field(alias="failureTime")] = None
    """
    FailureTime stores the time that this CertificateRequest failed. This is
    used to influence garbage collection and back-off.
    """
...
class CertificateSpec(BaseModel):
    ...
    signature_algorithm: Annotated[
        ...
        Field(alias="signatureAlgorithm"),
    ] = None
    """
    Signature algorithm to use.
    Allowed values for RSA keys: SHA256WithRSA, SHA384WithRSA, SHA512WithRSA.
...
class CertificateStatus(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def last_failure_time(self, value: Optional[AwareDatetime], /) -> Self:
            """
        ...
        def not_after(self, value: Optional[AwareDatetime], /) -> Self:
            """
        ...
        def not_before(self, value: Optional[AwareDatetime], /) -> Self:
            """
        ...
        def renewal_time(self, value: Optional[AwareDatetime], /) -> Self:
            """
    ...
    time.Hour * 2 ^ (failedIssuanceAttempts - 1).
    """
    last_failure_time: Annotated[Optional[AwareDatetime], Field(alias="lastFailureTime")] = None
    """
    LastFailureTime is set only if the latest issuance for this
    Certificate failed and contains the time of the failure. If an
    issuance has failed, the delay till the next issuance will be
    ...
    not set or False.
    """
    not_after: Annotated[Optional[AwareDatetime], Field(alias="notAfter")] = None
    """
    The expiration time of the certificate stored in the secret named
    by this resource in `spec.secretName`.
    """
    not_before: Annotated[Optional[AwareDatetime], Field(alias="notBefore")] = None
    """
    The time after which the certificate stored in the secret named
    by this resource in `spec.secretName` is valid.
    """
    renewal_time: Annotated[Optional[AwareDatetime], Field(alias="renewalTime")] = None
    """
    RenewalTime is the time at which the certificate will be next
    renewed.
    If not set, no upcoming renewal is scheduled.
...
class Rfc2136(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def protocol(self, value: Optional[Literal["TCP", "UDP"]], /) -> Self:
            """
...
class Spec(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def resources(self, value_or_callback: Optional[Resources], /) -> "Spec.Builder": ...
