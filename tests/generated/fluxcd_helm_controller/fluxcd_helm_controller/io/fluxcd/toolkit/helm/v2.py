...
class DependsOn(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def ready_expr(self, value: Optional[str], /) -> Self:
            """
    ...
    resource object that contains the reference.
    """
    ready_expr: Annotated[Optional[str], Field(alias="readyExpr")] = None
    """
    ReadyExpr is a CEL expression that can be used to assess the readiness
    of a dependency. When specified, the built-in readiness check
    is replaced by the logic defined in the CEL expression.
...
class Install(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def strategy(self, value_or_callback: Optional[Strategy], /) -> "Install.Builder": ...
...
class StrategyModel(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["StrategyModel"]:
            return StrategyModel

        def build(self) -> "StrategyModel":
            return StrategyModel(**self._attrs)
    ...
    class BuilderContext(BuilderContextBase["StrategyModel.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = StrategyModel.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for StrategyModel."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["StrategyModel", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use StrategyModel.list_builder() instead."
            )
...
class Upgrade(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def strategy(self, value_or_callback: Optional[StrategyModel], /) -> "Upgrade.Builder": ...

        @overload
        def strategy(
            self,
            value_or_callback: Callable[
                [StrategyModel.Builder], StrategyModel.Builder | StrategyModel
            ],
            /,
        ) -> "Upgrade.Builder": ...

        @overload
        def strategy(self, value_or_callback: Never = ...) -> "StrategyModel.BuilderContext": ...
        ...
        def strategy(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = StrategyModel.BuilderContext()
                context._parent_builder = self
                context._field_name = "strategy"
                return context
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(StrategyModel.builder())
                if isinstance(output, StrategyModel.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("strategy", value)
...
class TestHooks(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def last_completed(self, value: Optional[AwareDatetime], /) -> Self:
            """
            LastCompleted is the time the test hook last completed.
            """
            return self._set("last_completed", value)

        def last_started(self, value: Optional[AwareDatetime], /) -> Self:
            """
    ...
    last_completed: Annotated[Optional[AwareDatetime], Field(alias="lastCompleted")] = None
    """
    LastCompleted is the time the test hook last completed.
    """
    last_started: Annotated[Optional[AwareDatetime], Field(alias="lastStarted")] = None
    """
    LastStarted is the time the test hook was last started.
    """
...
class History(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def deleted(self, value: Optional[AwareDatetime], /) -> Self:
            """
    ...
    It has the format of `<algo>:<checksum>`.
    """
    deleted: Optional[AwareDatetime] = None
    """
    Deleted is when the release was deleted.
    """
    digest: str
...
class HelmReleaseStatus(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def last_attempted_release_action_duration(self, value: Optional[str], /) -> Self:
            """
        ...
        def observed_common_metadata_digest(self, value: Optional[str], /) -> Self:
            """
    ...
    last_attempted_release_action_duration: Annotated[
        Optional[str], Field(alias="lastAttemptedReleaseActionDuration")
    ] = None
    """
    LastAttemptedReleaseActionDuration is the duration of the last
    release action performed for this HelmRelease.
    ...
    observed_common_metadata_digest: Annotated[
        Optional[str], Field(alias="observedCommonMetadataDigest")
    ] = None
    """
    ObservedCommonMetadataDigest is the digest for the common metadata of
    the last successful reconciliation attempt.
