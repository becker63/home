...
class SourceRef(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def kind(
            self,
            value: Literal["OCIRepository", "GitRepository", "Bucket", "ExternalArtifact"],
            /,
        ) -> Self:
            """
            Kind of the referent.
    ...
    API version of the referent.
    """
    kind: Literal["OCIRepository", "GitRepository", "Bucket", "ExternalArtifact"]
    """
    Kind of the referent.
    """
    name: str
...
class KustomizationSpec(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def deletion_policy(
            self,
            value: Optional[Literal["MirrorPrune", "Delete", "WaitForTermination", "Orphan"]],
            /,
        ) -> Self:
            """
        ...
        def ignore_missing_components(self, value: Optional[bool], /) -> Self:
            """
            ...
            """
            return self._set("ignore_missing_components", value)
    ...
    deletion_policy: Annotated[
        Optional[Literal["MirrorPrune", "Delete", "WaitForTermination", "Orphan"]],
    ...
    A list of resources to be included in the health assessment.
    """
    ignore_missing_components: Annotated[Optional[bool], Field(alias="ignoreMissingComponents")] = (
        None
    )
    """
    IgnoreMissingComponents instructs the controller to ignore Components paths
...
class History(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def first_reconciled(self, value: AwareDatetime, /) -> Self:
            """
            FirstReconciled is the time when this revision was first reconciled to the cluster.
            """
            return self._set("first_reconciled", value)

        def last_reconciled(self, value: AwareDatetime, /) -> Self:
            """
            LastReconciled is the time when this revision was last reconciled to the cluster.
            """
            return self._set("last_reconciled", value)

        def last_reconciled_duration(self, value: str, /) -> Self:
            """
            LastReconciledDuration is time it took to reconcile the resources in this revision.
            """
            return self._set("last_reconciled_duration", value)

        def last_reconciled_status(self, value: str, /) -> Self:
            """
            LastReconciledStatus is the status of the last reconciliation.
            """
            return self._set("last_reconciled_status", value)
    ...
    Digest is the checksum in the format `<algo>:<hex>` of the resources in this snapshot.
    """
    first_reconciled: Annotated[AwareDatetime, Field(alias="firstReconciled")]
    """
    FirstReconciled is the time when this revision was first reconciled to the cluster.
    """
    last_reconciled: Annotated[AwareDatetime, Field(alias="lastReconciled")]
    """
    LastReconciled is the time when this revision was last reconciled to the cluster.
    """
    last_reconciled_duration: Annotated[str, Field(alias="lastReconciledDuration")]
    """
    LastReconciledDuration is time it took to reconcile the resources in this revision.
    """
    last_reconciled_status: Annotated[str, Field(alias="lastReconciledStatus")]
    """
    LastReconciledStatus is the status of the last reconciliation.
    """
    ...
    Metadata contains additional information about the snapshot.
    """
    total_reconciliations: Annotated[int, Field(alias="totalReconciliations")]
    """
    TotalReconciliations is the total number of reconciliations that have occurred for this snapshot.
    """
...
class KustomizationStatus(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def history(self, value_or_callback: List[History], /) -> "KustomizationStatus.Builder": ...
