...
class RollingUpdate(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["RollingUpdate"]:
            return RollingUpdate

        def build(self) -> "RollingUpdate":
            return RollingUpdate(**self._attrs)

        def max_surge(self, value: Optional[Union[int, str]], /) -> Self:
            """
        ...
        def max_unavailable(self, value: Optional[Union[int, str]], /) -> Self:
            """
    ...
    class BuilderContext(BuilderContextBase["RollingUpdate.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = RollingUpdate.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for RollingUpdate."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["RollingUpdate", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use RollingUpdate.list_builder() instead."
            )
    ...
    max_surge: Annotated[Optional[Union[int, str]], Field(alias="maxSurge")] = None
    """
    The maximum number of pods that can be scheduled above the desired number of
    pods.
    Value can be an absolute number (ex: 5) or a percentage of desired pods (ex: 10%).
    ...
    at any time during the update is at most 130% of desired pods.
    """
    max_unavailable: Annotated[Optional[Union[int, str]], Field(alias="maxUnavailable")] = None
    """
    The maximum number of pods that can be unavailable during the update.
    Value can be an absolute number (ex: 5) or a percentage of desired pods (ex: 10%).
    Absolute number is calculated from percentage by rounding down.
...
class Strategy(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def build(self) -> "Strategy":
            return Strategy(**self._attrs)

        @overload
        def rolling_update(
            self, value_or_callback: Optional[RollingUpdate], /
        ) -> "Strategy.Builder": ...
        ...
        def rolling_update(
            self,
            value_or_callback: Callable[
                [RollingUpdate.Builder], RollingUpdate.Builder | RollingUpdate
            ],
            /,
        ) -> "Strategy.Builder": ...
        ...
        def rolling_update(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = RollingUpdate.BuilderContext()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(RollingUpdate.builder())
                if isinstance(output, RollingUpdate.Builder):
                    value = output.build()
                else:
                    value = output
    ...
    class BuilderContext(BuilderContextBase["Strategy.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = Strategy.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for Strategy."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["Strategy", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use Strategy.list_builder() instead."
            )
    ...
    rolling_update: Annotated[Optional[RollingUpdate], Field(alias="rollingUpdate")] = None
    """
    Rolling update config params. Present only if DeploymentStrategyType =
    RollingUpdate.
    """
...
class FileKeyRef(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["FileKeyRef"]:
            return FileKeyRef

        def build(self) -> "FileKeyRef":
            return FileKeyRef(**self._attrs)
        ...
        def volume_name(self, value: str, /) -> Self:
            """
            The name of the volume mount containing the env file.
            """
            return self._set("volume_name", value)

    class BuilderContext(BuilderContextBase["FileKeyRef.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = FileKeyRef.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for FileKeyRef."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["FileKeyRef", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use FileKeyRef.list_builder() instead."
            )
    ...
    Must be relative and may not contain the '..' path or start with '..'.
    """
    volume_name: Annotated[str, Field(alias="volumeName")]
    """
    The name of the volume mount containing the env file.
    """
...
class ValueFrom(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def file_key_ref(
            self, value_or_callback: Optional[FileKeyRef], /
        ) -> "ValueFrom.Builder": ...

        @overload
        def file_key_ref(
            self,
            value_or_callback: Callable[[FileKeyRef.Builder], FileKeyRef.Builder | FileKeyRef],
            /,
        ) -> "ValueFrom.Builder": ...

        @overload
        def file_key_ref(self, value_or_callback: Never = ...) -> "FileKeyRef.BuilderContext": ...

        def file_key_ref(self, value_or_callback=None, /):
            """
            FileKeyRef selects a key of the env file.
            Requires the EnvFiles feature gate to be enabled.
            """
            if self._in_context and value_or_callback is None:
                context = FileKeyRef.BuilderContext()
                context._parent_builder = self
                context._field_name = "file_key_ref"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(FileKeyRef.builder())
                if isinstance(output, FileKeyRef.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("file_key_ref", value)
    ...
    spec.nodeName, spec.serviceAccountName, status.hostIP, status.podIP, status.podIPs.
    """
    file_key_ref: Annotated[Optional[FileKeyRef], Field(alias="fileKeyRef")] = None
    """
    FileKeyRef selects a key of the env file.
    Requires the EnvFiles feature gate to be enabled.
    """
...
class Lifecycle(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def stop_signal(self, value: Optional[str], /) -> Self:
            """
            StopSignal defines which signal will be sent to a container when it is being stopped.
            If not specified, the default is defined by the container runtime in use.
            StopSignal can only be set for Pods with a non-empty .spec.os.name
            """
            return self._set("stop_signal", value)
    ...
    More info: https://kubernetes.io/docs/concepts/containers/container-lifecycle-hooks/#container-hooks
    """
    stop_signal: Annotated[Optional[str], Field(alias="stopSignal")] = None
    """
    StopSignal defines which signal will be sent to a container when it is being stopped.
    If not specified, the default is defined by the container runtime in use.
    StopSignal can only be set for Pods with a non-empty .spec.os.name
...
class ExitCodes(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["ExitCodes"]:
            return ExitCodes

        def build(self) -> "ExitCodes":
            return ExitCodes(**self._attrs)
        ...
        def values(self, value: Optional[List[int]], /) -> Self:
            """
    ...
    class BuilderContext(BuilderContextBase["ExitCodes.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = ExitCodes.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for ExitCodes."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["ExitCodes", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use ExitCodes.list_builder() instead."
            )
...
class RestartPolicyRule(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["RestartPolicyRule"]:
            return RestartPolicyRule

        def build(self) -> "RestartPolicyRule":
            return RestartPolicyRule(**self._attrs)
        ...
        @overload
        def exit_codes(
            self, value_or_callback: Optional[ExitCodes], /
        ) -> "RestartPolicyRule.Builder": ...

        @overload
        def exit_codes(
            self,
            value_or_callback: Callable[[ExitCodes.Builder], ExitCodes.Builder | ExitCodes],
            /,
        ) -> "RestartPolicyRule.Builder": ...

        @overload
        def exit_codes(self, value_or_callback: Never = ...) -> "ExitCodes.BuilderContext": ...

        def exit_codes(self, value_or_callback=None, /):
            """
            Represents the exit codes to check on container exits.
            """
            if self._in_context and value_or_callback is None:
                context = ExitCodes.BuilderContext()
                context._parent_builder = self
                context._field_name = "exit_codes"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(ExitCodes.builder())
                if isinstance(output, ExitCodes.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("exit_codes", value)

    class BuilderContext(BuilderContextBase["RestartPolicyRule.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = RestartPolicyRule.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for RestartPolicyRule."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["RestartPolicyRule", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use RestartPolicyRule.list_builder() instead."
            )
    ...
    container.
    """
    exit_codes: Annotated[Optional[ExitCodes], Field(alias="exitCodes")] = None
    """
    Represents the exit codes to check on container exits.
    """
...
class Container(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def restart_policy_rules(
            self, value_or_callback: List[RestartPolicyRule], /
        ) -> "Container.Builder": ...
        ...
        def restart_policy_rules(
            self,
            value_or_callback: Callable[
                [GenericListBuilder[RestartPolicyRule, RestartPolicyRule.Builder]],
                GenericListBuilder[RestartPolicyRule, RestartPolicyRule.Builder]
                | List[RestartPolicyRule],
            ],
            /,
        ) -> "Container.Builder": ...
        ...
        def restart_policy_rules(
            self, value_or_callback: Never = ...
        ) -> ListBuilderContext[RestartPolicyRule.Builder]: ...

        def restart_policy_rules(self, value_or_callback=None, /):
            """
            ...
            """
            if self._in_context and value_or_callback is None:
                context = ListBuilderContext[RestartPolicyRule.Builder]()
                context._parent_builder = self
                context._field_name = "restart_policy_rules"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(RestartPolicyRule.list_builder())
                if isinstance(output, GenericListBuilder):
                    value = output.build()
                else:
                    value = output
            return self._set("restart_policy_rules", value)
    ...
    restart_policy_rules: Annotated[
        Optional[List[RestartPolicyRule]], Field(alias="restartPolicyRules")
    ] = None
    """
    Represents a list of rules to be checked to determine if the
    container should be restarted on exit. The rules are evaluated in
...
class EphemeralContainer(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def env(self, value_or_callback: List[Env], /) -> "EphemeralContainer.Builder": ...
...
class ResourcesModel(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def limits(self, value: Optional[Dict[str, Union[LimitsModel7, LimitsModel8]]], /) -> Self:
            """
            Limits describes the maximum amount of compute resources allowed.
            More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/
            """
        ...
        def requests(
            self, value: Optional[Dict[str, Union[RequestsModel7, RequestsModel8]]], /
        ) -> Self:
            """
            Requests describes the minimum amount of compute resources required.
            If Requests is omitted for a container, it defaults to Limits if that is explicitly specified,
...
class PodCertificate(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["PodCertificate"]:
            return PodCertificate

        def build(self) -> "PodCertificate":
            return PodCertificate(**self._attrs)

        def certificate_chain_path(self, value: Optional[str], /) -> Self:
            """
            ...
            files mid-rotation.
            """
            return self._set("certificate_chain_path", value)

        def credential_bundle_path(self, value: Optional[str], /) -> Self:
            """
            ...
            """
            return self._set("credential_bundle_path", value)

        def key_path(self, value: Optional[str], /) -> Self:
            """
            ...
            files mid-rotation.
            """
            return self._set("key_path", value)

        def key_type(self, value: str, /) -> Self:
            """
            ...
            """
            return self._set("key_type", value)

        def max_expiration_seconds(self, value: Optional[int], /) -> Self:
            """
    ...
    class BuilderContext(BuilderContextBase["PodCertificate.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = PodCertificate.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for PodCertificate."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["PodCertificate", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use PodCertificate.list_builder() instead."
            )
    ...
    certificate_chain_path: Annotated[Optional[str], Field(alias="certificateChainPath")] = None
    """
    Write the certificate chain at this path in the projected volume.
    ...
    files mid-rotation.
    """
    credential_bundle_path: Annotated[Optional[str], Field(alias="credentialBundlePath")] = None
    """
    Write the credential bundle at this path in the projected volume.
    ...
    additionally check that the leaf certificate was issued to the key.
    """
    key_path: Annotated[Optional[str], Field(alias="keyPath")] = None
    """
    Write the key at this path in the projected volume.
    ...
    files mid-rotation.
    """
    key_type: Annotated[str, Field(alias="keyType")]
    """
    The type of keypair Kubelet will generate for the pod.
    ...
    "ECDSAP521", and "ED25519".
    """
    max_expiration_seconds: Annotated[Optional[int], Field(alias="maxExpirationSeconds")] = None
    """
    maxExpirationSeconds is the maximum lifetime permitted for the
    certificate.
...
class Secret(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def items(self, value_or_callback: List[ItemModel3], /) -> "Secret.Builder": ...
...
class Source(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def pod_certificate(
            self, value_or_callback: Optional[PodCertificate], /
        ) -> "Source.Builder": ...
        ...
        def pod_certificate(
            self,
            value_or_callback: Callable[
                [PodCertificate.Builder], PodCertificate.Builder | PodCertificate
            ],
            /,
        ) -> "Source.Builder": ...
        ...
        def pod_certificate(
            self, value_or_callback: Never = ...
        ) -> "PodCertificate.BuilderContext": ...

        def pod_certificate(self, value_or_callback=None, /):
            """
            ...
            """
            if self._in_context and value_or_callback is None:
                context = PodCertificate.BuilderContext()
                context._parent_builder = self
                context._field_name = "pod_certificate"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(PodCertificate.builder())
                if isinstance(output, PodCertificate.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("pod_certificate", value)
    ...
    downwardAPI information about the downwardAPI data to project
    """
    pod_certificate: Annotated[Optional[PodCertificate], Field(alias="podCertificate")] = None
    """
    Projects an auto-rotating credential bundle (private key and certificate
    chain) that the pod can use either as a TLS client or server.
...
class SpecModel(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def hostname_override(self, value: Optional[str], /) -> Self:
            """
            ...
            """
            return self._set("hostname_override", value)
        ...
        @overload
        def resources(self, value_or_callback: Optional[Resources], /) -> "SpecModel.Builder": ...
    ...
    If not specified, the pod's hostname will be set to a system-defined value.
    """
    hostname_override: Annotated[Optional[str], Field(alias="hostnameOverride")] = None
    """
    HostnameOverride specifies an explicit override for the pod's hostname as perceived by the pod.
    This field only specifies the pod's hostname and does not affect its DNS records.
    When this field is set to a non-empty string:
...
class Template(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def metadata(self, value_or_callback: Optional[MetadataModel], /) -> "Template.Builder": ...
...
class SpecModel1(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["SpecModel1"]:
            return SpecModel1

        def build(self) -> "SpecModel1":
            return SpecModel1(**self._attrs)
        ...
        @overload
        def selector(self, value_or_callback: Selector, /) -> "SpecModel1.Builder": ...
        ...
        @overload
        def strategy(self, value_or_callback: Optional[Strategy], /) -> "SpecModel1.Builder": ...

        @overload
        def strategy(
            self,
            value_or_callback: Callable[[Strategy.Builder], Strategy.Builder | Strategy],
            /,
        ) -> "SpecModel1.Builder": ...

        @overload
        def strategy(self, value_or_callback: Never = ...) -> "Strategy.BuilderContext": ...
        ...
        def strategy(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = Strategy.BuilderContext()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(Strategy.builder())
                if isinstance(output, Strategy.Builder):
                    value = output.build()
                else:
                    value = output
        ...
        @overload
        def template(self, value_or_callback: Template, /) -> "SpecModel1.Builder": ...
    ...
    class BuilderContext(BuilderContextBase["SpecModel1.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = SpecModel1.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for SpecModel1."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["SpecModel1", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use SpecModel1.list_builder() instead."
            )
...
class DeploymentTemplate(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["DeploymentTemplate"]:
            return DeploymentTemplate

        def build(self) -> "DeploymentTemplate":
            return DeploymentTemplate(**self._attrs)
        ...
        @overload
        def spec(
            self, value_or_callback: Optional[SpecModel1], /
        ) -> "DeploymentTemplate.Builder": ...

        @overload
        def spec(
            self,
            value_or_callback: Callable[[SpecModel1.Builder], SpecModel1.Builder | SpecModel1],
            /,
        ) -> "DeploymentTemplate.Builder": ...

        @overload
        def spec(self, value_or_callback: Never = ...) -> "SpecModel1.BuilderContext": ...
        ...
        def spec(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = SpecModel1.BuilderContext()
                context._parent_builder = self
                context._field_name = "spec"
                return context
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(SpecModel1.builder())
                if isinstance(output, SpecModel1.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("spec", value)

    class BuilderContext(BuilderContextBase["DeploymentTemplate.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = DeploymentTemplate.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for DeploymentTemplate."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["DeploymentTemplate", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use DeploymentTemplate.list_builder() instead."
            )
...
class ServiceAccountTemplate(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["ServiceAccountTemplate"]:
            return ServiceAccountTemplate

        def build(self) -> "ServiceAccountTemplate":
            return ServiceAccountTemplate(**self._attrs)

        @overload
        def metadata(
            self, value_or_callback: Optional[MetadataModel1], /
        ) -> "ServiceAccountTemplate.Builder": ...

        @overload
        def metadata(
            self,
            value_or_callback: Callable[
                [MetadataModel1.Builder], MetadataModel1.Builder | MetadataModel1
            ],
            /,
        ) -> "ServiceAccountTemplate.Builder": ...

        @overload
        def metadata(self, value_or_callback: Never = ...) -> "MetadataModel1.BuilderContext": ...
        ...
        def metadata(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = MetadataModel1.BuilderContext()
                context._parent_builder = self
                context._field_name = "metadata"
                return context
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(MetadataModel1.builder())
                if isinstance(output, MetadataModel1.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("metadata", value)

    class BuilderContext(BuilderContextBase["ServiceAccountTemplate.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = ServiceAccountTemplate.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for ServiceAccountTemplate."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["ServiceAccountTemplate", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use ServiceAccountTemplate.list_builder() instead."
            )
...
class ServiceTemplate(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["ServiceTemplate"]:
            return ServiceTemplate

        def build(self) -> "ServiceTemplate":
            return ServiceTemplate(**self._attrs)
    ...
    class BuilderContext(BuilderContextBase["ServiceTemplate.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = ServiceTemplate.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for ServiceTemplate."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["ServiceTemplate", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use ServiceTemplate.list_builder() instead."
            )
...
class DeploymentRuntimeConfigSpec(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["DeploymentRuntimeConfigSpec"]:
            return DeploymentRuntimeConfigSpec

        def build(self) -> "DeploymentRuntimeConfigSpec":
            return DeploymentRuntimeConfigSpec(**self._attrs)

        @overload
        def deployment_template(
            self, value_or_callback: Optional[DeploymentTemplate], /
        ) -> "DeploymentRuntimeConfigSpec.Builder": ...
        ...
        def deployment_template(
            ...
            value_or_callback: Callable[
                [DeploymentTemplate.Builder],
                DeploymentTemplate.Builder | DeploymentTemplate,
            ],
            /,
        ) -> "DeploymentRuntimeConfigSpec.Builder": ...
        ...
        def deployment_template(
            self, value_or_callback: Never = ...
        ) -> "DeploymentTemplate.BuilderContext": ...

        def deployment_template(self, value_or_callback=None, /):
            """
            DeploymentTemplate is the template for the Deployment object.
            """
            if self._in_context and value_or_callback is None:
                context = DeploymentTemplate.BuilderContext()
                context._parent_builder = self
                context._field_name = "deployment_template"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(DeploymentTemplate.builder())
                if isinstance(output, DeploymentTemplate.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("deployment_template", value)

        @overload
        def service_account_template(
            self, value_or_callback: Optional[ServiceAccountTemplate], /
        ) -> "DeploymentRuntimeConfigSpec.Builder": ...
        ...
        def service_account_template(
            ...
            value_or_callback: Callable[
                [ServiceAccountTemplate.Builder],
                ServiceAccountTemplate.Builder | ServiceAccountTemplate,
            ],
            /,
        ) -> "DeploymentRuntimeConfigSpec.Builder": ...
        ...
        def service_account_template(
            self, value_or_callback: Never = ...
        ) -> "ServiceAccountTemplate.BuilderContext": ...

        def service_account_template(self, value_or_callback=None, /):
            """
            ServiceAccountTemplate is the template for the ServiceAccount object.
            """
            if self._in_context and value_or_callback is None:
                context = ServiceAccountTemplate.BuilderContext()
                context._parent_builder = self
                context._field_name = "service_account_template"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(ServiceAccountTemplate.builder())
                if isinstance(output, ServiceAccountTemplate.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("service_account_template", value)

        @overload
        def service_template(
            self, value_or_callback: Optional[ServiceTemplate], /
        ) -> "DeploymentRuntimeConfigSpec.Builder": ...
        ...
        def service_template(
            self,
            value_or_callback: Callable[
                [ServiceTemplate.Builder], ServiceTemplate.Builder | ServiceTemplate
            ],
            /,
        ) -> "DeploymentRuntimeConfigSpec.Builder": ...
        ...
        def service_template(
            self, value_or_callback: Never = ...
        ) -> "ServiceTemplate.BuilderContext": ...

        def service_template(self, value_or_callback=None, /):
            """
            ServiceTemplate is the template for the Service object.
            """
            if self._in_context and value_or_callback is None:
                context = ServiceTemplate.BuilderContext()
                context._parent_builder = self
                context._field_name = "service_template"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(ServiceTemplate.builder())
                if isinstance(output, ServiceTemplate.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("service_template", value)

    class BuilderContext(BuilderContextBase["DeploymentRuntimeConfigSpec.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = DeploymentRuntimeConfigSpec.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for DeploymentRuntimeConfigSpec."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["DeploymentRuntimeConfigSpec", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use DeploymentRuntimeConfigSpec.list_builder() instead."
            )
    ...
    deployment_template: Annotated[
        Optional[DeploymentTemplate], Field(alias="deploymentTemplate")
    ] = None
    """
    DeploymentTemplate is the template for the Deployment object.
    """
    service_account_template: Annotated[
        Optional[ServiceAccountTemplate], Field(alias="serviceAccountTemplate")
    ] = None
    """
    ServiceAccountTemplate is the template for the ServiceAccount object.
    """
    service_template: Annotated[Optional[ServiceTemplate], Field(alias="serviceTemplate")] = None
    """
    ServiceTemplate is the template for the Service object.
    """
...
class MatchImage(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["MatchImage"]:
            return MatchImage

        def build(self) -> "MatchImage":
            return MatchImage(**self._attrs)
        ...
        def type(self, value: Optional[Literal["Prefix"]], /) -> Self:
            """
            Type is the type of match.
            """
            return self._set("type", value)

    class BuilderContext(BuilderContextBase["MatchImage.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = MatchImage.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for MatchImage."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["MatchImage", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use MatchImage.list_builder() instead."
            )
...
class PullSecretRef(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["PullSecretRef"]:
            return PullSecretRef

        def build(self) -> "PullSecretRef":
            return PullSecretRef(**self._attrs)
    ...
    class BuilderContext(BuilderContextBase["PullSecretRef.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = PullSecretRef.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for PullSecretRef."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["PullSecretRef", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use PullSecretRef.list_builder() instead."
            )
...
class Authentication(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def pull_secret_ref(
            self, value_or_callback: PullSecretRef, /
        ...
        def pull_secret_ref(
            self,
            value_or_callback: Callable[
                [PullSecretRef.Builder], PullSecretRef.Builder | PullSecretRef
            ],
            /,
        ) -> "Authentication.Builder": ...
        ...
        def pull_secret_ref(
            self, value_or_callback: Never = ...
        ) -> "PullSecretRef.BuilderContext": ...

        def pull_secret_ref(self, value_or_callback=None, /):
            """
            PullSecretRef is a reference to a secret that contains the credentials for
            the registry.
            """
            if self._in_context and value_or_callback is None:
                context = PullSecretRef.BuilderContext()
                context._parent_builder = self
                context._field_name = "pull_secret_ref"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(PullSecretRef.builder())
                if isinstance(output, PullSecretRef.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("pull_secret_ref", value)
    ...
    pull_secret_ref: Annotated[PullSecretRef, Field(alias="pullSecretRef")]
    """
    PullSecretRef is a reference to a secret that contains the credentials for
    the registry.
    """
...
class RewriteImage(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["RewriteImage"]:
            return RewriteImage

        def build(self) -> "RewriteImage":
            return RewriteImage(**self._attrs)
    ...
    class BuilderContext(BuilderContextBase["RewriteImage.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = RewriteImage.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for RewriteImage."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["RewriteImage", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use RewriteImage.list_builder() instead."
            )
...
class Runtime(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def config_ref(self, value_or_callback: Optional[ConfigRef], /) -> "Runtime.Builder": ...
...
class Attestation(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def predicate_type(self, value: str, /) -> Self:
            """
    ...
    Name of the attestation.
    """
    predicate_type: Annotated[str, Field(alias="predicateType")]
    """
    PredicateType defines which predicate type to verify. Matches cosign
    verify-attestation options.
    """
...
class Key(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def hash_algorithm(self, value: Optional[str], /) -> Self:
            """
            HashAlgorithm always defaults to sha256 if the algorithm hasn't been explicitly set
            """
            return self._set("hash_algorithm", value)

        @overload
        def secret_ref(self, value_or_callback: SecretRefModel1, /) -> "Key.Builder": ...

        @overload
        def secret_ref(
            self,
            value_or_callback: Callable[
                [SecretRefModel1.Builder], SecretRefModel1.Builder | SecretRefModel1
            ],
            /,
        ) -> "Key.Builder": ...
        ...
        def secret_ref(
            self, value_or_callback: Never = ...
        ) -> "SecretRefModel1.BuilderContext": ...
        ...
        def secret_ref(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = SecretRefModel1.BuilderContext()
                context._parent_builder = self
                context._field_name = "secret_ref"
                return context
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(SecretRefModel1.builder())
                if isinstance(output, SecretRefModel1.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("secret_ref", value)
    ...
    hash_algorithm: Annotated[Optional[str], Field(alias="hashAlgorithm")] = "sha256"
    """
    HashAlgorithm always defaults to sha256 if the algorithm hasn't been explicitly set
    """
    secret_ref: Annotated[SecretRefModel1, Field(alias="secretRef")]
    """
    SecretRef sets a reference to a secret with the key.
    """
...
class Identity(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["Identity"]:
            return Identity

        def build(self) -> "Identity":
            return Identity(**self._attrs)
    ...
    class BuilderContext(BuilderContextBase["Identity.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = Identity.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for Identity."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["Identity", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use Identity.list_builder() instead."
            )
...
class Keyless(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def identities(self, value_or_callback: List[Identity], /) -> "Keyless.Builder": ...

        @overload
        def identities(
            self,
            value_or_callback: Callable[
                [GenericListBuilder[Identity, Identity.Builder]],
                GenericListBuilder[Identity, Identity.Builder] | List[Identity],
            ],
            /,
        ) -> "Keyless.Builder": ...
        ...
        def identities(
            self, value_or_callback: Never = ...
        ) -> ListBuilderContext[Identity.Builder]: ...

        def identities(self, value_or_callback=None, /):
            """
            Identities sets a list of identities.
            """
            if self._in_context and value_or_callback is None:
                context = ListBuilderContext[Identity.Builder]()
                context._parent_builder = self
                context._field_name = "identities"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(Identity.list_builder())
                if isinstance(output, GenericListBuilder):
                    value = output.build()
                else:
                    value = output
            return self._set("identities", value)

        def insecure_ignore_sct(self, value: Optional[bool], /) -> Self:
            """
            InsecureIgnoreSCT omits verifying if a certificate contains an embedded SCT
            """
            return self._set("insecure_ignore_sct", value)
    ...
    Identities sets a list of identities.
    """
    insecure_ignore_sct: Annotated[Optional[bool], Field(alias="insecureIgnoreSCT")] = None
    """
    InsecureIgnoreSCT omits verifying if a certificate contains an embedded SCT
    """
...
class Authority(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def attestations(self, value_or_callback: List[Attestation], /) -> "Authority.Builder": ...
        ...
        @overload
        def key(self, value_or_callback: Optional[Key], /) -> "Authority.Builder": ...

        @overload
        def key(
            self, value_or_callback: Callable[[Key.Builder], Key.Builder | Key], /
        ) -> "Authority.Builder": ...

        @overload
        def key(self, value_or_callback: Never = ...) -> "Key.BuilderContext": ...

        def key(self, value_or_callback=None, /):
            """
            Key defines the type of key to validate the image.
            """
            if self._in_context and value_or_callback is None:
                context = Key.BuilderContext()
                context._parent_builder = self
                context._field_name = "key"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(Key.builder())
                if isinstance(output, Key.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("key", value)
        ...
        @overload
        def keyless(self, value_or_callback: Optional[Keyless], /) -> "Authority.Builder": ...
...
class Cosign(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["Cosign"]:
            return Cosign

        def build(self) -> "Cosign":
            return Cosign(**self._attrs)

        @overload
        def authorities(self, value_or_callback: List[Authority], /) -> "Cosign.Builder": ...

        @overload
        def authorities(
            self,
            value_or_callback: Callable[
                [GenericListBuilder[Authority, Authority.Builder]],
                GenericListBuilder[Authority, Authority.Builder] | List[Authority],
            ],
            /,
        ) -> "Cosign.Builder": ...
        ...
        def authorities(
            self, value_or_callback: Never = ...
        ) -> ListBuilderContext[Authority.Builder]: ...

        def authorities(self, value_or_callback=None, /):
            """
            Authorities defines the rules for discovering and validating signatures.
            """
            if self._in_context and value_or_callback is None:
                context = ListBuilderContext[Authority.Builder]()
                context._parent_builder = self
                context._field_name = "authorities"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(Authority.list_builder())
                if isinstance(output, GenericListBuilder):
                    value = output.build()
                else:
                    value = output
            return self._set("authorities", value)

    class BuilderContext(BuilderContextBase["Cosign.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = Cosign.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for Cosign."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["Cosign", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use Cosign.list_builder() instead."
            )
...
class Verification(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["Verification"]:
            return Verification

        def build(self) -> "Verification":
            return Verification(**self._attrs)

        @overload
        def cosign(self, value_or_callback: Optional[Cosign], /) -> "Verification.Builder": ...

        @overload
        def cosign(
            self,
            value_or_callback: Callable[[Cosign.Builder], Cosign.Builder | Cosign],
            /,
        ) -> "Verification.Builder": ...

        @overload
        def cosign(self, value_or_callback: Never = ...) -> "Cosign.BuilderContext": ...
        ...
        def cosign(self, value_or_callback=None, /):
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(Cosign.builder())
                if isinstance(output, Cosign.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("cosign", value)

        def provider(self, value: Literal["Cosign"], /) -> Self:
            """
            Provider is the provider that should be used to verify the image.
            """
            return self._set("provider", value)

    class BuilderContext(BuilderContextBase["Verification.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = Verification.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for Verification."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["Verification", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use Verification.list_builder() instead."
            )
...
class ImageConfigSpec(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["ImageConfigSpec"]:
            return ImageConfigSpec

        def build(self) -> "ImageConfigSpec":
            return ImageConfigSpec(**self._attrs)

        @overload
        def match_images(
            self, value_or_callback: List[MatchImage], /
        ) -> "ImageConfigSpec.Builder": ...

        @overload
        def match_images(
            self,
            value_or_callback: Callable[
                [GenericListBuilder[MatchImage, MatchImage.Builder]],
                GenericListBuilder[MatchImage, MatchImage.Builder] | List[MatchImage],
            ],
            /,
        ) -> "ImageConfigSpec.Builder": ...
        ...
        def match_images(
            self, value_or_callback: Never = ...
        ) -> ListBuilderContext[MatchImage.Builder]: ...

        def match_images(self, value_or_callback=None, /):
            """
            ...
            """
            if self._in_context and value_or_callback is None:
                context = ListBuilderContext[MatchImage.Builder]()
                context._parent_builder = self
                context._field_name = "match_images"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(MatchImage.list_builder())
                if isinstance(output, GenericListBuilder):
                    value = output.build()
                else:
                    value = output
            return self._set("match_images", value)

        @overload
        def registry(
            self, value_or_callback: Optional[Registry], /
        ) -> "ImageConfigSpec.Builder": ...
        ...
        @overload
        def rewrite_image(
            self, value_or_callback: Optional[RewriteImage], /
        ) -> "ImageConfigSpec.Builder": ...
        ...
        def rewrite_image(
            self,
            value_or_callback: Callable[
                [RewriteImage.Builder], RewriteImage.Builder | RewriteImage
            ],
            /,
        ) -> "ImageConfigSpec.Builder": ...
        ...
        def rewrite_image(
            self, value_or_callback: Never = ...
        ) -> "RewriteImage.BuilderContext": ...

        def rewrite_image(self, value_or_callback=None, /):
            """
            RewriteImage defines how a matched image's path should be rewritten.
            """
            if self._in_context and value_or_callback is None:
                context = RewriteImage.BuilderContext()
                context._parent_builder = self
                context._field_name = "rewrite_image"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(RewriteImage.builder())
                if isinstance(output, RewriteImage.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("rewrite_image", value)

        @overload
        def runtime(self, value_or_callback: Optional[Runtime], /) -> "ImageConfigSpec.Builder": ...
        ...
        @overload
        def verification(
            self, value_or_callback: Optional[Verification], /
        ) -> "ImageConfigSpec.Builder": ...
        ...
        def verification(
            self,
            value_or_callback: Callable[
                [Verification.Builder], Verification.Builder | Verification
            ],
            /,
        ) -> "ImageConfigSpec.Builder": ...

        @overload
        def verification(self, value_or_callback: Never = ...) -> "Verification.BuilderContext": ...

        def verification(self, value_or_callback=None, /):
            """
            Verification contains the configuration for verifying the image.
            """
            if self._in_context and value_or_callback is None:
                context = Verification.BuilderContext()
                context._parent_builder = self
                context._field_name = "verification"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(Verification.builder())
                if isinstance(output, Verification.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("verification", value)

    class BuilderContext(BuilderContextBase["ImageConfigSpec.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = ImageConfigSpec.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for ImageConfigSpec."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["ImageConfigSpec", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use ImageConfigSpec.list_builder() instead."
            )
    ...
    match_images: Annotated[List[MatchImage], Field(alias="matchImages")]
    """
    MatchImages is a list of image matching rules. This ImageConfig will
    match an image if any one of these rules is satisfied. In the case where
    multiple ImageConfigs match an image for a given purpose the one with the
    ...
    Registry is the configuration for the registry.
    """
    rewrite_image: Annotated[Optional[RewriteImage], Field(alias="rewriteImage")] = None
    """
    RewriteImage defines how a matched image's path should be rewritten.
    """
...
class Dependency(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["Dependency"]:
            return Dependency

        def build(self) -> "Dependency":
            return Dependency(**self._attrs)
        ...
        def constraints(self, value: str, /) -> Self:
            """
        ...
        def type(
            self, value: Optional[Literal["Configuration", "Provider", "Function"]], /
        ) -> Self:
            """
    ...
    class BuilderContext(BuilderContextBase["Dependency.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = Dependency.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for Dependency."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["Dependency", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use Dependency.list_builder() instead."
            )
...
class Package(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["Package"]:
            return Package

        def build(self) -> "Package":
            return Package(**self._attrs)
        ...
        @overload
        def dependencies(self, value_or_callback: List[Dependency], /) -> "Package.Builder": ...

        @overload
        def dependencies(
            self,
            value_or_callback: Callable[
                [GenericListBuilder[Dependency, Dependency.Builder]],
                GenericListBuilder[Dependency, Dependency.Builder] | List[Dependency],
            ],
            /,
        ) -> "Package.Builder": ...
        ...
        def dependencies(
            self, value_or_callback: Never = ...
        ) -> ListBuilderContext[Dependency.Builder]: ...

        def dependencies(self, value_or_callback=None, /):
            """
            ...
            """
            if self._in_context and value_or_callback is None:
                context = ListBuilderContext[Dependency.Builder]()
                context._parent_builder = self
                context._field_name = "dependencies"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(Dependency.list_builder())
                if isinstance(output, GenericListBuilder):
                    value = output.build()
                else:
                    value = output
    ...
    class BuilderContext(BuilderContextBase["Package.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = Package.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for Package."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["Package", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use Package.list_builder() instead."
            )
...
class LockStatus(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["LockStatus"]:
            return LockStatus

        def build(self) -> "LockStatus":
            return LockStatus(**self._attrs)

        @overload
        def conditions(self, value_or_callback: List[Condition], /) -> "LockStatus.Builder": ...
    ...
    class BuilderContext(BuilderContextBase["LockStatus.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = LockStatus.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for LockStatus."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["LockStatus", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use LockStatus.list_builder() instead."
            )
...
class DeploymentRuntimeConfig(Resource):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["DeploymentRuntimeConfig"]:
            return DeploymentRuntimeConfig

        def build(self) -> "DeploymentRuntimeConfig":
            return DeploymentRuntimeConfig(**self._attrs)

        def api_version(self, value: Optional[Literal["pkg.crossplane.io/v1beta1"]], /) -> Self:
            """
        ...
        def kind(self, value: Optional[Literal["DeploymentRuntimeConfig"]], /) -> Self:
            """
        ...
        ) -> "DeploymentRuntimeConfig.Builder": ...
        ...
        @overload
        def spec(
            self, value_or_callback: Optional[DeploymentRuntimeConfigSpec], /
        ) -> "DeploymentRuntimeConfig.Builder": ...
        ...
        def spec(
            ...
            value_or_callback: Callable[
                [DeploymentRuntimeConfigSpec.Builder],
                DeploymentRuntimeConfigSpec.Builder | DeploymentRuntimeConfigSpec,
            ],
            /,
        ) -> "DeploymentRuntimeConfig.Builder": ...
        ...
        def spec(
            self, value_or_callback: Never = ...
        ) -> "DeploymentRuntimeConfigSpec.BuilderContext": ...

        def spec(self, value_or_callback=None, /):
            if self._in_context and value_or_callback is None:
                context = DeploymentRuntimeConfigSpec.BuilderContext()
                context._parent_builder = self
                context._field_name = "spec"
                return context
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(DeploymentRuntimeConfigSpec.builder())
                if isinstance(output, DeploymentRuntimeConfigSpec.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("spec", value)

    class BuilderContext(BuilderContextBase["DeploymentRuntimeConfig.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = DeploymentRuntimeConfig.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for DeploymentRuntimeConfig."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["DeploymentRuntimeConfig", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use DeploymentRuntimeConfig.list_builder() instead."
            )
    ...
    api_version: Annotated[
        Optional[Literal["pkg.crossplane.io/v1beta1"]], Field(alias="apiVersion")
    ...
    spec: Optional[DeploymentRuntimeConfigSpec] = None
...
class ImageConfig(Resource):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["ImageConfig"]:
            return ImageConfig

        def build(self) -> "ImageConfig":
            return ImageConfig(**self._attrs)
        ...
        def kind(self, value: Optional[Literal["ImageConfig"]], /) -> Self:
            """
            Kind is a string value representing the REST resource this object represents.
            Servers may infer this from the endpoint the client submits requests to.
            Cannot be updated.
        ...
        @overload
        def spec(
            self, value_or_callback: Optional[ImageConfigSpec], /
        ) -> "ImageConfig.Builder": ...
        ...
        def spec(
            self,
            value_or_callback: Callable[
                [ImageConfigSpec.Builder], ImageConfigSpec.Builder | ImageConfigSpec
            ],
            /,
        ) -> "ImageConfig.Builder": ...

        @overload
        def spec(self, value_or_callback: Never = ...) -> "ImageConfigSpec.BuilderContext": ...

        def spec(self, value_or_callback=None, /):
            if self._in_context and value_or_callback is None:
                context = ImageConfigSpec.BuilderContext()
                context._parent_builder = self
                context._field_name = "spec"
                return context
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(ImageConfigSpec.builder())
                if isinstance(output, ImageConfigSpec.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("spec", value)

    class BuilderContext(BuilderContextBase["ImageConfig.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = ImageConfig.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for ImageConfig."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["ImageConfig", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use ImageConfig.list_builder() instead."
            )
    ...
    """
    metadata: Optional[apimachinery.ObjectMeta] = None
    spec: Optional[ImageConfigSpec] = None


class Lock(Resource):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["Lock"]:
            return Lock

        def build(self) -> "Lock":
            return Lock(**self._attrs)
        ...
        def kind(self, value: Optional[Literal["Lock"]], /) -> Self:
            """
            Kind is a string value representing the REST resource this object represents.
            Servers may infer this from the endpoint the client submits requests to.
            Cannot be updated.
        ...
        @overload
        def packages(self, value_or_callback: List[Package], /) -> "Lock.Builder": ...

        @overload
        def packages(
            self,
            value_or_callback: Callable[
                [GenericListBuilder[Package, Package.Builder]],
                GenericListBuilder[Package, Package.Builder] | List[Package],
            ],
            /,
        ) -> "Lock.Builder": ...
        ...
        def packages(
            self, value_or_callback: Never = ...
        ) -> ListBuilderContext[Package.Builder]: ...

        def packages(self, value_or_callback=None, /):
            if self._in_context and value_or_callback is None:
                context = ListBuilderContext[Package.Builder]()
                context._parent_builder = self
                context._field_name = "packages"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(Package.list_builder())
                if isinstance(output, GenericListBuilder):
                    value = output.build()
                else:
                    value = output
            return self._set("packages", value)

        @overload
        def status(self, value_or_callback: Optional[LockStatus], /) -> "Lock.Builder": ...

        @overload
        def status(
            self,
            value_or_callback: Callable[[LockStatus.Builder], LockStatus.Builder | LockStatus],
            /,
        ) -> "Lock.Builder": ...

        @overload
        def status(self, value_or_callback: Never = ...) -> "LockStatus.BuilderContext": ...

        def status(self, value_or_callback=None, /):
            if self._in_context and value_or_callback is None:
                context = LockStatus.BuilderContext()
                context._parent_builder = self
                context._field_name = "status"
                return context
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(LockStatus.builder())
                if isinstance(output, LockStatus.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("status", value)

    class BuilderContext(BuilderContextBase["Lock.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = Lock.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for Lock."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["Lock", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use Lock.list_builder() instead."
            )
