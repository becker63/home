...
class ForProvider(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def distribution(self, value: Optional[str], /) -> Self:
            """
...
class ImageSpec(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def for_provider(self, value_or_callback: ForProvider, /) -> "ImageSpec.Builder": ...
...
class AtProvider(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def image_id(self, value: Optional[float], /) -> Self:
            """
        ...
        def public(self, value: Optional[bool], /) -> Self:
            """
            Indicates whether the image in question is public or not.
            """
            return self._set("public", value)
        ...
        def size_gigabytes(self, value: Optional[float], /) -> Self:
            """
            The size of the image in gigabytes.
            """
            return self._set("size_gigabytes", value)

        def slug(self, value: Optional[str], /) -> Self:
            """
            A uniquely identifying string for each image.
            """
            return self._set("slug", value)
    ...
    image_id: Annotated[Optional[float], Field(alias="imageId")] = None
    """
    A unique number that can be used to identify and reference a specific image.
    """
    ...
    A list of regions. (Currently only one is supported).
    """
    size_gigabytes: Annotated[Optional[float], Field(alias="sizeGigabytes")] = None
    """
    The size of the image in gigabytes.
    """
...
class Image(Resource):
    class Builder(BaseModelBuilder):
        ...
        def api_version(
            self,
            value: Optional[Literal["custom.digitalocean.crossplane.io/v1alpha1"]],
            /,
        ) -> Self:
            """
    ...
    api_version: Annotated[
        Optional[Literal["custom.digitalocean.crossplane.io/v1alpha1"]],
        Field(alias="apiVersion"),
    ] = "custom.digitalocean.crossplane.io/v1alpha1"
    """
    APIVersion defines the versioned schema of this representation of an object.
    Servers should convert recognized schemas to the latest internal value, and
    may reject unrecognized values.
