...
class CheckSpec(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["CheckSpec"]:
            return CheckSpec

        def build(self) -> "CheckSpec":
            return CheckSpec(**self._attrs)
        ...
        @overload
        def for_provider(self, value_or_callback: ForProviderModel, /) -> "CheckSpec.Builder": ...
    ...
    class BuilderContext(BuilderContextBase["CheckSpec.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = CheckSpec.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for CheckSpec."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["CheckSpec", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use CheckSpec.list_builder() instead."
            )
...
class CheckStatus(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["CheckStatus"]:
            return CheckStatus

        def build(self) -> "CheckStatus":
            return CheckStatus(**self._attrs)
        ...
        @overload
        def conditions(self, value_or_callback: List[Condition], /) -> "CheckStatus.Builder": ...
    ...
    class BuilderContext(BuilderContextBase["CheckStatus.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = CheckStatus.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for CheckStatus."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["CheckStatus", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use CheckStatus.list_builder() instead."
            )
...
class Check(Resource):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["Check"]:
            return Check

        def build(self) -> "Check":
            return Check(**self._attrs)
        ...
        def kind(self, value: Optional[Literal["Check"]], /) -> Self:
            """
            Kind is a string value representing the REST resource this object represents.
            Servers may infer this from the endpoint the client submits requests to.
            Cannot be updated.
        ...
        @overload
        def spec(self, value_or_callback: CheckSpec, /) -> "Check.Builder": ...

        @overload
        def spec(
            self,
            value_or_callback: Callable[[CheckSpec.Builder], CheckSpec.Builder | CheckSpec],
            /,
        ) -> "Check.Builder": ...

        @overload
        def spec(self, value_or_callback: Never = ...) -> "CheckSpec.BuilderContext": ...

        def spec(self, value_or_callback=None, /):
            if self._in_context and value_or_callback is None:
                context = CheckSpec.BuilderContext()
                context._parent_builder = self
                context._field_name = "spec"
                return context
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(CheckSpec.builder())
                if isinstance(output, CheckSpec.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("spec", value)
        ...
        @overload
        def status(self, value_or_callback: Optional[CheckStatus], /) -> "Check.Builder": ...

        @overload
        def status(
            self,
            value_or_callback: Callable[[CheckStatus.Builder], CheckStatus.Builder | CheckStatus],
            /,
        ) -> "Check.Builder": ...

        @overload
        def status(self, value_or_callback: Never = ...) -> "CheckStatus.BuilderContext": ...

        def status(self, value_or_callback=None, /):
            if self._in_context and value_or_callback is None:
                context = CheckStatus.BuilderContext()
                context._parent_builder = self
                context._field_name = "status"
                return context
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(CheckStatus.builder())
                if isinstance(output, CheckStatus.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("status", value)

    class BuilderContext(BuilderContextBase["Check.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = Check.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for Check."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["Check", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use Check.list_builder() instead."
            )
    ...
    More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    kind: Optional[Literal["Check"]] = "Check"
    """
    Kind is a string value representing the REST resource this object represents.
    Servers may infer this from the endpoint the client submits requests to.
    Cannot be updated.
